...
var locationVEB = ["VEB1500030", "VEB1500029", "VEB1500015", "VEB1500012", "VEB1500013", "VEB1500018", "VEB1500038", "VEB1500014","VEB1500022","VEB1500032", "VEB1500041", "VEB1500026", "VEB1500033", "VEB1500016"];
        ...
        fetch(url)
            ...
            .then((data) => { // FETCH RMS3
                if (data.result == "ok")
                {
                    ...
                    dialog.alert({ title: "Errore", message: data.details + location[place], okButtonText: "OK" });
                    flag = false;
                }
            })
